...
public class EnemyCrudRepositoryIT {
    ...
    public void save_CorrectCount_WhenSaveOneEnemyTwoWeakOneResistTwoImmune() {
        // Arrange
        List<EEnemyElement> weaknesses = Collections.<EEnemyElement> emptyList(); //List.of(new EEnemyElement(1L, "Lightning"), new EEnemyElement(2L, "Dark"));
        List<EEnemyElement> resistances = Collections.<EEnemyElement> emptyList(); //List.of(new EEnemyElement(3L, "Fire"));
        List<EEnemyElement> immunities = Collections.<EEnemyElement> emptyList(); //List.of(new EEnemyElement(4L, "Poison"), new EEnemyElement(5L, "Toxic"));
